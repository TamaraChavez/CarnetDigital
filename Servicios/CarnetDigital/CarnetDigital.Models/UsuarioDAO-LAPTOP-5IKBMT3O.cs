...
{
    public class UsuarioDAO  //Voya  tomar las 
    {
        [Required(AllowEmptyStrings = false, ErrorMessage = "El tipo de iendentificación es requerido")]//NO PERMITE QUE EL STRING VENGA VACIO
